  ...
  return (
    <div className="h-full">
      <header className="mx-auto p-5 text-white max-w-[1240px]">
            ...
            <div className="icons flex">
              {data ? (
                <button onClick={() => setDropdown(!dropdown)}>
                  ...
                  {dropdown ? (
                    <ul
                      className="menu absolute mt-4 p-4 bg-cyan-400/70 divide-y-2 rounded-md z-30"
                      ref={myRef}>
                      <li className="menu-item px-4 py-2">
                        <Link to="/profile" className="text-white b-2">
                          Profile
                        </Link>
                      </li>
                      <li className="menu-item px-4 py-2">
        ...
        {/*Mobile Nav*/}
        {!isOpen ? (
          <div className="lower-nav-mobile mt-8 sm:hidden" onClick={() => setIsOpen(!isOpen)}>
            <div>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
        ...
        <ul
          className={
            isOpen
              ? ' font-bold z-[6] fixed left-0 top-0 w-full h-full text-2xl border-r border-r-gray-900 bg-[#000300] ease-in-out duration-500'
          ...
          <li className="p-4 border-b border-gray-600" onClick={() => setDropDown(!dropDown)}>
            <p className="flex">
              Shop
              <span>
                <svg
            ...
            {dropDown ? <MobDropDown data={isOpen} /> : ''}
          </li>
          <li className="p-4 border-b border-gray-600">
            <Link to="/typing" onClick={() => setIsOpen(false)}>
              Typing
            </Link>
          </li>
          <li className="p-4 border-b border-gray-600">
            <Link to="/wiki" onClick={() => setIsOpen(false)}>
              Wiki
            </Link>
          </li>
          <li className="p-4 border-b border-gray-600">
        ...
        <div className="lower-nav mt-8 hidden sm:block">
          <ul className="flex font-bold text-2xl relative flex-wrap gap-16 gap-y-8">
            ...
            <li className="relative" id="navShop">
  ...
  return (
    <div className="dropdown">
      <ul className="pl-4 py-4">
        <li className="py-1">
          <Link to="/shop" onClick={() => props.data(false)}>
            All items
          </Link>
        </li>
        <li className="py-1">
