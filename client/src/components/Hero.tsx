...
function Hero() {
  ...
  <path strokeLinecap="round" strokeLinejoin="round"
        d="M12 18a3.75 3.75 0 00.495-7.467 5.99 5.99 0 00-1.925 3.546 5.974 5.974 0 01-2.133-1A3.75 3.75 0 0012 18z"/>
                ...
                <Link to="product" className="text-white py-2 px-6 mt-8 bg-gradient-to-r from-cyan-300/80 to-cyan-200/80 rounded-2xl font-bold text-xl hover:opacity-90 active:translate-y-0.5">Buy now</Link>
            </div>
