      ...
      <div className="grid grid-cols-1 md:grid-cols-2 2xl:grid-cols-4 grid-rows-4 justify-items-stretch gap-4 text-white text-2xl text-center h-full">
        <div className="box border-2 rounded-2xl col-span-1 md:col-span-2">
          <div className="cursor-pointer rounded-2xl flex flex-col items-center justify-center transition-all duration-500 ease-in-out">
            <div className="content-card w-full relative hover:opacity-80 transition-all duration-500 ease-in-out h-[270px]">
              <img
                src="https://cdn.vox-cdn.com/thumbor/9uzysqQG30oPn7BVYkmLr3uaeuo=/0x0:2040x1360/1200x628/filters:focal(1020x680:1021x681)/cdn.vox-cdn.com/uploads/chorus_asset/file/24055256/226317_Mechanical_Keyboard_Buying_Guide_JPorter_0001.jpg"
                alt=""
        ...
        <div className="box border-2 rounded-2xl row-span-1 md:row-span-2">
          <div className="cursor-pointer rounded-2xl flex flex-col items-center justify-center transition-all duration-500 ease-in-out">
            <div className="content-card w-full relative hover:opacity-80   transition-all duration-500 ease-in-out h-[560px]">
              <img
                src="http://cdn.shopify.com/s/files/1/0582/0242/3501/collections/switches-657317.png?v=1648553632"
                alt=""
                className="h-full object-cover w-full rounded-2xl"
              />
              <p className="absolute left-0 bottom-0 rounded-b-2xl text-2xl font-bold bg-gray-600/50 shadow-2xl p-4">
                What is switch?
              </p>
            </div>
          </div>
        ...
        <div className="box border-2 rounded-2xl row-span-1 md:row-span-2">
          <div className="cursor-pointer rounded-2xl flex flex-col items-center justify-center transition-all duration-500 ease-in-out">
            <div className="content-card w-full relative hover:opacity-80   transition-all duration-500 ease-in-out h-[560px]">
              <img
                src="https://www.mechkeybs.com/wp-content/uploads/2021/03/Custom-Keycaps-1024x512.jpg"
                alt=""
                className="h-full object-cover w-full rounded-2xl"
              />
              <p className="absolute left-0 bottom-0 rounded-b-2xl text-2xl font-bold bg-gray-600/50 shadow-2xl p-4">
        ...
        <div className="box border-2 rounded-2xl col-span-1 md:col-span-2">
          <div className="cursor-pointer rounded-2xl flex flex-col items-center justify-center transition-all duration-500 ease-in-out">
            <div className="content-card w-full relative hover:opacity-80 transition-all duration-500 ease-in-out h-[270px]">
              <img
                src="https://www.raypcb.com/wp-content/uploads/2021/02/custom-keyboard-pcb.jpg"
                alt=""
                className="h-full object-cover w-full rounded-2xl"
              />
              <p className="absolute left-0 bottom-0 rounded-bl-2xl text-2xl font-bold bg-gray-600/50 shadow-2xl p-4">
        ...
        <div className="box border-2 rounded-2xl row-span-1 md:row-span-2">
          <div className="cursor-pointer rounded-2xl flex flex-col items-center justify-center transition-all duration-500 ease-in-out">
            <div className="content-card w-full relative hover:opacity-80   transition-all duration-500 ease-in-out h-[560px]">
              <img
                src="https://cdn.shopify.com/s/files/1/2711/4238/products/HTB1vfAKRFXXXXbnXpXXq6xXFXXX3_600x.jpg?v=1617000801"
                alt=""
                className="h-full object-cover w-full rounded-2xl"
              />
              <p className="absolute left-0 bottom-0 rounded-b-2xl text-2xl font-bold bg-gray-600/50 shadow-2xl p-4">
        ...
        <div className="box border-2 rounded-2xl row-span-1 md:row-span-2">
          <div className="cursor-pointer rounded-2xl flex flex-col items-center justify-center transition-all duration-500 ease-in-out">
            <div className="content-card w-full relative hover:opacity-80   transition-all duration-500 ease-in-out h-[560px]">
              <img
                src="https://keyboardsexpert.com/wp-content/uploads/2021/08/Custom-Keyboard-Case-covered-photo.jpg?ezimgfmt=rs:352x235/rscb1/ngcb1/notWebP"
                alt=""
                className="h-full object-cover w-full rounded-2xl"
              />
              <p className="absolute left-0 bottom-0 rounded-b-2xl text-2xl font-bold bg-gray-600/50 shadow-2xl p-4">
        ...
        <div className="box border-2 rounded-2xl col-span-1 md:col-span-2">
          <div className="cursor-pointer rounded-2xl flex flex-col items-center justify-center transition-all duration-500 ease-in-out">
            <div className="content-card w-full relative hover:opacity-80 transition-all duration-500 ease-in-out h-[270px]">
              <img
                src="https://m.media-amazon.com/images/W/IMAGERENDERING_521856-T1/images/I/71m7s0QnElS.jpg"
                alt=""
                className="h-full object-cover w-full rounded-2xl"
              />
              <p className="absolute left-0 bottom-0 rounded-bl-2xl text-2xl font-bold bg-gray-600/50 shadow-2xl p-4">
        ...
        <div className="box border-2 rounded-2xl col-span-1 md:col-span-2">
          <div className="cursor-pointer rounded-2xl flex flex-col items-center justify-center transition-all duration-500 ease-in-out">
            <div className="content-card w-full relative hover:opacity-80 transition-all duration-500 ease-in-out h-[270px]">
              <img
                src="https://i.imgur.com/4saapo8.jpg"
                alt=""
                className="h-full object-cover w-full rounded-2xl"
              />
              <p className="absolute left-0 bottom-0 rounded-bl-2xl text-2xl font-bold bg-gray-600/50 shadow-2xl p-4">
